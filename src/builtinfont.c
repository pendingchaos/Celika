...
//From https://github.com/bkaradzic/bgfx/blob/master/src/charset.h
const uint8_t builtin_font[128*16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
bool get_builtin_font_at(char c, size_t x, size_t y) {
    return builtin_font[c*16+y] & (1<<(7-x));
}
